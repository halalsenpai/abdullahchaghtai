        ...
        <div className="grid md:grid-cols-[2fr,1fr] gap-12">
          ...
          >
            <div className="prose prose-lg dark:prose-invert">
              <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-2xl 
                            shadow-lg dark:shadow-gray-900/50 p-8 space-y-6">
          ...
          >
            <div className="sticky top-24">
              <div className="relative">
                {/* Image Container */}
                <div className="relative z-10 rounded-2xl overflow-hidden bg-white dark:bg-gray-800 
              ...
              <div className="mt-6 space-y-2">
                <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-xl p-4 
                              shadow-lg dark:shadow-gray-900/50">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 dark:text-gray-400">Full Stack Engineer</span>
                    <span className="font-medium text-amber-600 dark:text-amber-500">4+ Years</span>
                  </div>
                </div>
                <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-xl p-4 
                              shadow-lg dark:shadow-gray-900/50">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <a href="/Abdullah-Chaghtai.pdf" className="font-medium text-amber-600 dark:text-amber-500">Download</a>
                  </div>
                </div>
              </div>
            </div>
